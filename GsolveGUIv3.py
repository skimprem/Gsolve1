...
class Ui_Gsolve(object):
    def setupUi(self, Gsolve):
        ...
        Gsolve.setTabShape(QtWidgets.QTabWidget.Rounded)
        Gsolve.setDockNestingEnabled(False)
        Gsolve.setUnifiedTitleAndToolBarOnMac(False)
        self.centralwidget = QtWidgets.QWidget(Gsolve)
        ...
        self.AddNewSurveyMeasurement = QtWidgets.QPushButton(self.tab)
        ...
        self.RemoveSurveyMeasurement = QtWidgets.QPushButton(self.tab)
        ...
        self.SurveyDataTab = QtWidgets.QTableWidget(self.tab)
        self.SurveyDataTab.setEditTriggers(QtWidgets.QAbstractItemView.AllEditTriggers)
        self.SurveyDataTab.setDragEnabled(True)
        self.SurveyDataTab.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.CalTabSelect = QtWidgets.QComboBox(self.frame_4)
        ...
        self.UseLoops = QtWidgets.QCheckBox(self.frame_4)
        ...
        self.MethodSelect = QtWidgets.QComboBox(self.frame_4)
        ...
        self.SolveAll = QtWidgets.QPushButton(self.frame_4)
        self.SolveAll.setGeometry(QtCore.QRect(10, 540, 261, 51))
        self.SolveAll.setObjectName(_fromUtf8("SolveAll"))
        self.CalculateBeta = QtWidgets.QCheckBox(self.frame_4)
        ...
        self.MainResultsTabview = QtWidgets.QTableWidget(self.frame_10)
        ...
        self.MainResultsTabview.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        self.ExportResults = QtWidgets.QPushButton(self.frame_10)
        ...
        self.LoopCDFSel = QtWidgets.QComboBox(self.frame_9)
        ...
        self.CDFplot = QtWidgets.QPushButton(self.frame_9)
        self.CDFplot.setGeometry(QtCore.QRect(90, 20, 121, 21))
        self.CDFplot.setObjectName(_fromUtf8("CDFplot"))
        self.LoopSel_2 = QtWidgets.QComboBox(self.frame_9)
        ...
        self.driftplot_2 = QtWidgets.QPushButton(self.frame_9)
        ...
        self.BetaOut = QtWidgets.QLineEdit(self.frame_8)
        ...
        self.DetailedResultsTabview = QtWidgets.QTableWidget(self.tab_4)
        self.DetailedResultsTabview.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        self.DriftTabview = QtWidgets.QTableWidget(self.tab_4)
        self.DriftTabview.setMinimumSize(QtCore.QSize(231, 192))
        self.DriftTabview.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        self.ExportDetailedResults = QtWidgets.QPushButton(self.tab_4)
        ...
        self.GravityReductionsTab = QtWidgets.QTableWidget(self.tab_5)
        ...
        self.GravityReductionsTab.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        self.ExportGravityreductions = QtWidgets.QPushButton(self.frame_13)
        ...
        self.Ellipsoidselect = QtWidgets.QComboBox(self.frame_13)
        ...
        self.UpdateEll = QtWidgets.QPushButton(self.frame_13)
        ...
        self.tabWidget_7 = QtWidgets.QTabWidget(self.page_6)
        self.tabWidget_7.setObjectName(_fromUtf8("tabWidget_7"))
        self.Importdata = QtWidgets.QWidget()
        self.Importdata.setObjectName(_fromUtf8("Importdata"))
        self.formLayout_3 = QtWidgets.QFormLayout(self.Importdata)
        self.formLayout_3.setObjectName(_fromUtf8("formLayout_3"))
        self.frame_7 = QtWidgets.QFrame(self.Importdata)
        ...
        self.ImportDEM = QtWidgets.QPushButton(self.frame_7)
        ...
        self.Resolution = QtWidgets.QLineEdit(self.groupBox_2)
        ...
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.frame_7)
        self.frame_14 = QtWidgets.QFrame(self.Importdata)
        ...
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.frame_14)
        ...
        self.EastingsNorthingsTC = QtWidgets.QTableWidget(self.widget_2)
        self.EastingsNorthingsTC.setGeometry(QtCore.QRect(10, 40, 741, 601))
        self.EastingsNorthingsTC.setEditTriggers(QtWidgets.QAbstractItemView.AllEditTriggers)
        ...
        self.ImportdatapointsTC = QtWidgets.QPushButton(self.widget_2)
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.widget_2)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.frame_16)
        ...
        self.widget_3 = QtWidgets.QWidget(self.tab_8)
        self.widget_3.setMinimumSize(QtCore.QSize(759, 659))
        self.widget_3.setObjectName(_fromUtf8("widget_3"))
        self.EastingsNorthingsTC_results = QtWidgets.QTableWidget(self.widget_3)
        self.EastingsNorthingsTC_results.setGeometry(QtCore.QRect(0, 20, 751, 461))
        self.EastingsNorthingsTC_results.setEditTriggers(QtWidgets.QAbstractItemView.AllEditTriggers)
        ...
        self.TCparameter_results.setEditTriggers(QtWidgets.QAbstractItemView.AllEditTriggers)
        ...
        self.menubar = QtWidgets.QMenuBar(Gsolve)
        ...
        self.statusbar = QtWidgets.QStatusBar(Gsolve)
        self.statusbar.setObjectName(_fromUtf8("statusbar"))
        Gsolve.setStatusBar(self.statusbar)
        self.dockWidget = QtWidgets.QDockWidget(Gsolve)
        ...
        self.ImportNewAbdG = QtWidgets.QTabWidget(self.dockWidgetContents_2)
        ...
        self.CalibrationTabSelectview = QtWidgets.QComboBox(self.frame_2)
        ...
        self.CalibrationTabView = QtWidgets.QTableWidget(self.frame_2)
        self.CalibrationTabView.setMouseTracking(False)
        self.CalibrationTabView.setAutoFillBackground(False)
        self.CalibrationTabView.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.CalibrationTabView.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.ImportNewCalTab = QtWidgets.QPushButton(self.frame_3)
        ...
        self.RemoveCalTab = QtWidgets.QPushButton(self.frame_2)
        ...
        self.ImportNewAbsG = QtWidgets.QPushButton(self.frame_11)
        ...
        self.actionNew = QtWidgets.QAction(Gsolve)
        self.actionNew.setObjectName(_fromUtf8("actionNew"))
        self.actionSave = QtWidgets.QAction(Gsolve)
        self.actionSave.setObjectName(_fromUtf8("actionSave"))
        self.actionOpen = QtWidgets.QAction(Gsolve)
        self.actionOpen.setObjectName(_fromUtf8("actionOpen"))
        self.actionExit = QtWidgets.QAction(Gsolve)
        self.actionExit.setObjectName(_fromUtf8("actionExit"))
        self.actionGsolve_Help = QtWidgets.QAction(Gsolve)
        self.actionGsolve_Help.setObjectName(_fromUtf8("actionGsolve_Help"))
        self.actionAbout = QtWidgets.QAction(Gsolve)
        ...
        self.CalculateBeta.toggled.connect(self.BetaIne.setDisabled)
